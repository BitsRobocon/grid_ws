...
import copy
# Replace bot_description by whatever package name you have given.
from state_estimation.msg import BotPose, BotTwist
from state_estimation.srv import SrvPose, SrvPoseRequest, SrvPoseResponse, SrvTwist, SrvTwistRequest, SrvTwistResponse
...
class detect_aruco():
    ...
    def service_pose(self, request):
        ...
        self.pose_response.uid = ['1', '2', '3', '4']
    ...
    def service_twist(self, request):
        ...
        self.twist_response.uid = ['1', '2', '3', '4']
